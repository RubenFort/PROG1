...
public class Principal {
    ...
    private static boolean validarUsuario(String user, String pass) {
        ...
        try {
            ...
            System.out.println("Falta fichero de usuarios. Se cierra la agenda");
            return false;
        } catch (RegistroUsuarioMalFormadoException e) {
            System.out.println("Fallo en linea " + lineaLeida
                    + " del fichero de usuarios . Se cierra la agenda");
            return false;
        }
