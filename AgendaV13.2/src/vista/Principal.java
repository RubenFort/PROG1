...
import usuarios.ErrorEnFicheroDeUsuarioException;
import usuarios.RegistroUsuarioMalFormadoException;
...
public class Principal {
    ...
    public static void main(String[] args) throws ErrorEnFicheroDeUsuarioException {
        ...
        do {
            ...
            try {
                usuarioValido = validarUsuario(user, pass);
            } catch (ErrorEnFicheroDeUsuarioException errorEnFicheroDeUsuarioException) {
                return;
            }
            if (!usuarioValido) {
                System.out.println();
                System.out.println("El usuario y/o la contraseña son incorrectos. Try again\n");
            }
        } while (!usuarioValido);
    ...
    private static boolean validarUsuario(String user, String pass) throws ErrorEnFicheroDeUsuarioException {
        //Cargamos los usuarios desde el fichero usuarios.txt
        boolean usuarioValido = false;
        String linea;
        Usuario usuario;
        ...
        try {
            ...
            throw new ErrorEnFicheroDeUsuarioException();
        }

        //Pedir usuario y contraseña y comprobar que está en el vector
        //de usuarios Lista Control Acceso
