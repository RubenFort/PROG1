...
public class Contacto {
    ...
    @Override//Anotacion: no es codigo, en este caso se usa para indicar que este metdo esta reescrito
    public boolean equals(Object obj) {
        //Mira si el objeto que recibimos es igual al que tenemos (si tienen la 
        //misma dirección en memoria, que justo, esa comparación es la que 
        //intentamos evita reescribiendo equal)
        if (this == obj) {
            return true;
        }
