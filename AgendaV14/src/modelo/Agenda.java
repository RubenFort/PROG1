...
//------------ Guardo el usuario y contraseña que está logueado en la sesion actual ------------
    public void sesion (Usuario u) {
        usuarioSesion = u;
    }

//------------ Recupero usuario y contraseña que está logueado en la sesion actual ------------
    public Usuario recuperarSesion () {
