...
//                    break;
    ...
    private static void cargarContactos() {
        ...
        contactos = new Contacto("Pepe Couto", new Fecha(12, 9, 1999), 676558996, Tipo.AMIGO, true);
        ...
        contactos = new Contacto("Luis Pérez", new Fecha(21, 1, 1965), 981212333, Tipo.ENEMIGO, false);
        cargaOk = miAgenda.addContacto(contactos);
        if (cargaOk == true) {
            System.out.println("Contacto cargado");
        } else {
        ...
        contactos = new Contacto("Juan Leis", new Fecha(27, 3, 1980), 981256567, Tipo.FAMILIA, true);
        cargaOk = miAgenda.addContacto(contactos);
        if (cargaOk == true) {
            System.out.println("Contacto cargado");
        } else {
        ...
        contactos = new Contacto("Ana Vila", new Fecha(11, 7, 1966), 657656454, Tipo.TRABAJO, false);
        cargaOk = miAgenda.addContacto(contactos);
        if (cargaOk == true) {
            System.out.println("Contacto cargado");
        } else {
