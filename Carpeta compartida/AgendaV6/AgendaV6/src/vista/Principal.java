...
public class Principal {
    ...
    private static void cargarContactos() {
        ...
        agenda.addContacto(new Contacto("Eva Rey", new Fecha(12, 7, 1900), 981212223, Tipo.AMIGO, true));
        agenda.addContacto(new Contacto("Luis Pérez", new Fecha(22, 3, 1960), 981212333, Tipo.AMIGO, false));
        agenda.addContacto(new Contacto("Juan Leis", new Fecha(13, 9, 1970), 981256567, Tipo.FAMILIAR, true));
        agenda.addContacto(new Contacto("Ana Dios", new Fecha(12, 07, 1900), 657656454, Tipo.ENEMIGO, false));
