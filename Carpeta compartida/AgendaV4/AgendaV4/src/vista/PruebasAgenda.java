...
public class PruebasAgenda {
    ...
    public static void main(String[] args) {
        ...
        if (agendaPruebas.addContacto(new Contacto("Adelina", new Fecha(12,7,1900), 981212223, 'F', true))) {
            System.out.println("Contacto SÍ añadido");
        } else {
            System.out.println("Agenda llena. Contacto NO añadido");
        }

        if (agendaPruebas.addContacto(new Contacto("Juana", new Fecha (22,3,1960), 786765565, 'A', false))) {
            System.out.println("Contacto SÍ añadido");
        } else {
            System.out.println("Agenda llena. Contacto NO añadido");
        }

        if (agendaPruebas.addContacto(new Contacto("Antonio",new Fecha(13,9,1970), 666555444, 'E', true))) {
            System.out.println("Contacto SÍ añadido");
        } else {
            System.out.println("Agenda llena. Contacto NO añadido");
        }
        ...
        if (agendaPruebas.addContacto(new Contacto("Contacto fallo", new Fecha(12,07,1900), 981212223, 'F', true))) {
            System.out.println("Contacto SÍ añadido");
        } else {
            System.out.println("Agenda llena. Contacto NO añadido");
        }
        ...
        if (agendaPruebas.addContacto(new Contacto("Nuevo contacto", new Fecha(3,4,1960), 987777777, 'F', true))) {
            System.out.println("Contacto SÍ añadido");
        } else {
            System.out.println("Agenda llena. Contacto NO añadido");
        }
