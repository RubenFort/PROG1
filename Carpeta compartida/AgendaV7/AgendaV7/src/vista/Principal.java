...
public class Principal {
    ...
    private static void cargarContactos() {
        ...
        agenda.addContacto(new Contacto("Eva Rey", new Date(0, 6, 12), 981212223, Tipo.AMIGO, true));
        agenda.addContacto(new Contacto("Luis Pérez", new Date(60, 2, 22), 981212333, Tipo.AMIGO, false));
        agenda.addContacto(new Contacto("Juan Leis", new Date(70, 8, 13), 981256567, Tipo.FAMILIAR, true));
        agenda.addContacto(new Contacto("Ana Dios", new Date(0, 6, 12), 657656454, Tipo.ENEMIGO, false));
    ...
    private static void mostrarDetalle() {
        ...
        if (buscado != null) {
            ...
            System.out.println("Fecha Nacimiento: " + deDateAString(buscado.getFechaNacimiento()));
    ...
    private static void nuevoContacto() {
        ...
        fechaNacimiento = new Date(año - 1900, mes - 1, dia);
    ...
    //Método de utlidad que convierte un Date a String con el formato dd/mm/aaaa
