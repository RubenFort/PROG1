...
//---------------------- Añadimos 3 contactos ----------------------
        ...
        if (miAgenda.addContacto(new Contacto("Pepe", new Fecha(26, 11, 1985), 676558996, 'A', true))) {
            System.out.println("Contacto guardado");
        } else {
            System.out.println("No se pudo añadir el contacto");
        }
        
        if (miAgenda.addContacto(new Contacto("Ana", new Fecha(04, 2, 1994), 677389574, 'T', true))) {
            System.out.println("Contacto guardado");
        } else {
            System.out.println("No se pudo añadir el contacto");
        }
        
        if (miAgenda.addContacto(new Contacto("Luis", new Fecha(16, 7, 2013), 981456654, 'A', false))) {
            System.out.println("Contacto guardado");
        } else {
            System.out.println("No se pudo añadir el contacto");
        }
...
//---------------------- Intentamos dar de alta un nuevo contacto (devería de devolver false) ----------------------
        ...
        if (miAgenda.addContacto(new Contacto("Alberto", new Fecha(8, 11, 1956), 986987877, 'T', false))) {
            System.out.println("Contacto guardado");
        } else {
...
//---------------------- Intentamos dar de alta un nuevo contacto (devería de devolver true+) ----------------------
        ...
        if (miAgenda.addContacto(new Contacto("Jaime", new Fecha(12, 8, 2008), 677981232, 'F', true))) {
            System.out.println("Contacto guardado");
        } else {
            System.out.println("No se pudo guardar el contacto, la agenda está llena");
        }
