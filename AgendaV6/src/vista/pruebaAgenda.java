...
//---------------------- Añadimos 3 contactos ----------------------
        ...
        if (miAgenda.addContacto(new Contacto("Pepe", new Date(85, 11, 23), 676558996, Tipo.AMIGO, true))) {
            System.out.println("Contacto guardado");
        } else {
            System.out.println("No se pudo añadir el contacto");
        }
        
        if (miAgenda.addContacto(new Contacto("Ana", new Date(94, 0, 12), 677389574, Tipo.ENEMIGO, true))) {
            System.out.println("Contacto guardado");
        } else {
            System.out.println("No se pudo añadir el contacto");
        }
        
        if (miAgenda.addContacto(new Contacto("Luis", new Date(113, 7, 5), 981456654, Tipo.FAMILIA, false))) {
            System.out.println("Contacto guardado");
        } else {
            System.out.println("No se pudo añadir el contacto");
        }
...
//---------------------- Intentamos dar de alta un nuevo contacto (devería de devolver false) ----------------------
        ...
        if (miAgenda.addContacto(new Contacto("Alberto", new Date(56, 10, 06), 986987877, Tipo.TRABAJO, false))) {
            System.out.println("Contacto guardado");
        } else {
...
//---------------------- Intentamos dar de alta un nuevo contacto (devería de devolver true+) ----------------------
        ...
        if (miAgenda.addContacto(new Contacto("Jaime", new Date(108, 7, 18), 677981232, Tipo.ENEMIGO, true))) {
            System.out.println("Contacto guardado");
        } else {
            System.out.println("No se pudo guardar el contacto, la agenda está llena");
        }
